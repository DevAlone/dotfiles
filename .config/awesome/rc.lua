...
beautiful.init("/home/user/.config/awesome/themes/" .. theme_name .. "/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag(tags, s, awful.layout.layouts[0])
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "1", function () mymainmenu:show() end,
    ...
    awful.key({ modkey,           }, "7", awful.client.urgent.jumpto,
    ...
    -- Prompt
    awful.key({ modkey },            "4",     function () awful.screen.focused().mypromptbox:run() end,
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "9",      function (c) c:move_to_screen()               end,
              {description = "move to screen", group = "client"}),
    awful.key({ modkey,           }, "5",      function (c) c.ontop = not c.ontop            end,
