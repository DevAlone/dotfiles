...
menubar.utils.terminal = globals.terminal_emulator
-- }}}
...
local tasklist_buttons = gears.table.join(
            ...
            if c == client.focus then
                ...
                c:raise()
                             ...
                             ), awful.button({}, 3, helpers.client_menu_toggle_fn()), awful.button(
                                 {}, 4, function()
