...
xinput set-prop "Elan Touchpad" "libinput Tapping Drag Lock Enabled" 1
...
xinput set-prop "Elan Touchpad" "libinput Accel Speed" 0.300000
xinput set-prop "Elan Touchpad" "libinput Left Handed Enabled" 1
